...
@admin.register(MainIndexAdditionService)
class MainIndexAdditionServiceAdmin(admin.ModelAdmin):
    list_display = ('id','title')
    list_display_links = ('id','title')
    #search_fields = ('id','title')
    list_filter = ('id','title')

@admin.register(MainIndexMedia)
class MainIndexMediaAdmin(admin.ModelAdmin):
...
@admin.register(LinksTable)
class LinksTableAdmin(admin.ModelAdmin):
    list_display = ('id','TelegramIcon','TelegramLink','WhatsappIcon','WhatsappLink', 'VKIcon','VKLink', 'ViberIcon','ViberLink', 'TwoGisIcon','TwoGisLink')
    list_display_links = ('id','TelegramIcon','TelegramLink','WhatsappIcon','WhatsappLink', 'VKIcon','VKLink', 'ViberIcon','ViberLink', 'TwoGisIcon','TwoGisLink')
    #search_fields = ('id','TelegramIcon','TelegramLink','WhatsappIcon','WhatsappLink', 'VKIcon','VKLink', 'ViberIcon','ViberLink', 'TwoGisIcon','TwoGisLink')
    list_filter = ('id','TelegramIcon','TelegramLink','WhatsappIcon','WhatsappLink', 'VKIcon','VKLink', 'ViberIcon','ViberLink', 'TwoGisIcon','TwoGisLink')
...
class LogoSiteAdmin(admin.ModelAdmin):
    list_display = ('id','logo','favicon')
    list_display_links = ('id','logo','favicon')
    #search_fields = ('id','LogoSite')
    list_filter = ('id','logo','favicon')
